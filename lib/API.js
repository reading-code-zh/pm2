...
class API {
   ...
   */
  connect (noDaemon, cb) {
    console.log('API 164',typeof(cb) == 'undefined');
    var that = this;
    ...
    this.Client.start(function(err, meta) {
      if (err)
        return cb(err);
      console.log('API 180', meta.new_pm2_instance == false && that.daemon_mode === true);
...
////////////////////////////
  ...
  _startScript (script, opts, cb) {
    ...
    console.log(723, app_conf.write);
    /**
    ...
    function restartExistingProcessName(cb) {
      console.log('restartExistingProcessName');
      if (!isNaN(script) ||
    ...
    function restartExistingNameSpace(cb) {
      console.log('restartExistingNameSpace');
    ...
    function restartExistingProcessId(cb) {
      console.log('restartExistingProcessId');
    ...
    function restartExistingProcessPathOrStartNew(cb) {
      console.log('restartExistingProcessPathOrStartNew');
